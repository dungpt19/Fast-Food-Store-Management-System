 	...
 	<div class="col-lg-7" style="border-left: 1px solid #ddd;">
    	...
    	<!-- order details -->
    		...
    		<!-- summary --> 
    			...
    			<table class="table table-bordered">
    				<thead>
    					...
    					<tr>
    						...
    						<th><input type="text" class="form-control"  name="tenderamount" id="tenderamount"  placeholder="&#8363 0.00" autocomplete="off"> <span id="errortrap"></span></th>
    					</tr>
    					<tr>
    						<th width="250">Change</th>
    						<th><input class="form-control" type="" class="sukli" readonly="true" name="sukli" id="sukli" value="" placeholder="&#8363 0.00"></th>
    					</tr>
    				</thead>
    			</table>
    			<div>
                ...
                <div>
                <a href="http://dungphamdoan.com/vnpay_php/" target="_blank" class="btn btn-danger">VNPAY PAYMENT</a>
